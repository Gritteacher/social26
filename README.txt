อัปเดต: สุ่มลำดับข้อสอบทุกครั้ง

ปรับหน้า quiz.html:
- เมื่อเปิดทำแบบทดสอบ ระบบจะสุ่มลำดับคำถามใหม่ทุกครั้ง
- คะแนนยังตรวจถูกต้องตามเฉลยเดิม
- นักเรียนยังเห็นเฉพาะคะแนนรวมและเปอร์เซ็นต์
- ไม่แสดงข้อถูก/ผิดและไม่แสดงเฉลย

หมายเหตุ:
- การสุ่มทำในฝั่งหน้าเว็บ quiz.html
- ถ้าต้องการปิดการสุ่ม ให้แก้ใน quiz.html:
  const SHUFFLE_QUESTIONS = false;


อัปเดต: แสดงคะแนนหลังส่งคำตอบ

ปรับหน้า quiz.html:
- หลังนักเรียนส่งคำตอบแล้ว จะแสดงเฉพาะคะแนนรวม เช่น 24/30 คะแนน
- แสดงเปอร์เซ็นต์คะแนน
- ไม่แสดงข้อถูก/ผิด
- ไม่แสดงเฉลย
- ระบบยังบันทึกและส่งผลให้ครูตามเดิม
